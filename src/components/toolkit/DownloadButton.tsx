...
export default function DownloadButton({ targetId, filename, width, height }: Props) {
  ...
  return (
    <button
      onClick={download}
      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary hover:bg-primary/80 text-white text-xs font-semibold transition-all hover:-translate-y-0.5"
    >
