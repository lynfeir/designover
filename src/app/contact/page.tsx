    ...
    <>
      ...
      <section className="relative bg-forest py-20 overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative">
          <span className="text-[10px] font-bold tracking-[0.25em] uppercase text-primary font-[family-name:var(--font-ui)] flex items-center gap-2 mb-4"><span className="inline-block w-1.5 h-1.5 bg-primary rotate-45" />
            Contact
          </span>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mb-4 font-[family-name:var(--font-display)]">
            Contact
          </h1>
          <p className="text-white/70 text-lg max-w-xl font-[family-name:var(--font-ui)]">
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-start">
            ...
            <div className="flex flex-col gap-5">
              <h2 className="text-2xl font-bold tracking-tight text-foreground mb-1 font-[family-name:var(--font-display)]">
                Get In Touch
              </h2>
              ...
              {[
                {
                  ...
                  content: (
                    <>
                      <a
                        href="tel:4707583549"
                        className="text-primary font-bold text-lg font-[family-name:var(--font-mono)]"
                      >
                        (470) 758-3549
                      </a>
                      <p className="text-muted-fg text-xs mt-1 m-0 font-[family-name:var(--font-ui)]">
                ...
                },
                {
                  ...
                  content: (
                    <p className="text-muted-fg text-sm m-0 font-[family-name:var(--font-ui)]">
                ...
                {
                  icon: <svg className="w-5 h-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
                  title: "Hours",
                  content: (
                    <p className="text-muted-fg text-sm m-0 font-[family-name:var(--font-ui)]">
                ...
                <div
                  key={c.title}
                  className="flex gap-4 items-start p-5 glass border border-border/30 tilt-card"
                >
                  <div className="w-10 h-10 bg-primary/10 flex items-center justify-center text-lg shrink-0">
                    {c.icon}
                  </div>
                  <div>
                    <h4 className="font-bold text-foreground text-sm mb-1 font-[family-name:var(--font-display)]">
                      {c.title}
                    </h4>
                    {c.content}
                  </div>
              ...
              <div className="bg-forest border border-forest p-7 text-center">
                <h4 className="text-white font-bold mb-2 font-[family-name:var(--font-display)]">
                  Need Something Today?
                </h4>
                <p className="text-white/70 text-sm mb-4 font-[family-name:var(--font-ui)]">
                ...
                <div className="flex gap-3 flex-wrap justify-center">
                  <a
                    href="tel:4707583549"
                    className="btn-shimmer text-white font-bold text-sm px-7 py-3.5 tracking-wider uppercase transition-colors font-[family-name:var(--font-ui)]"
                  >
                    Call Now
                  </a>
                  <a
                    href="sms:4707583549"
                    className="border border-white/25 hover:border-white/40 hover:bg-white/[0.04] text-white font-bold text-sm px-7 py-3.5 tracking-wider uppercase transition-colors font-[family-name:var(--font-ui)]"
                  >
                    Text Hunter
                  </a>
                </div>
      ...
      <section className="py-24 bg-card">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="max-w-2xl mb-14">
            <span className="text-[10px] font-bold tracking-[0.25em] uppercase text-primary font-[family-name:var(--font-ui)] flex items-center gap-2 mb-3"><span className="inline-block w-1.5 h-1.5 bg-primary rotate-45" />
              FAQ
            </span>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground font-[family-name:var(--font-display)]">
              Common Questions
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-5 max-w-4xl">
            {[
              ...
              <div
                key={faq.q}
                className="bg-card border border-border/30 p-7"
              >
                <h4 className="font-bold text-foreground text-sm mb-2 font-[family-name:var(--font-display)]">
                  {faq.q}
                </h4>
                <p className="text-muted-fg text-sm leading-relaxed m-0 font-[family-name:var(--font-ui)]">
                  {faq.a}
                </p>
              </div>
            ))}
      ...
      <section className="relative py-20 bg-forest overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white mb-4 font-[family-name:var(--font-display)]">
            Your Business Is Losing Money on Manual Work
          </h2>
          <p className="text-white/70 max-w-lg mb-8 text-lg font-[family-name:var(--font-ui)]">
          ...
          <div className="flex gap-3 flex-wrap">
            <a
              href="tel:4707583549"
              className="btn-shimmer text-white font-bold px-7 py-3.5 text-sm tracking-wider uppercase transition-colors font-[family-name:var(--font-ui)]"
            >
              Call (470) 758-3549
            </a>
            <Link
              href="#contact-form"
              className="border border-white/25 hover:border-white/40 hover:bg-white/[0.04] text-white font-bold px-7 py-3.5 text-sm tracking-wider uppercase transition-colors font-[family-name:var(--font-ui)]"
            >
              Fill Out the Form
            </Link>
          </div>
