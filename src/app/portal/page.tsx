...
async function fetchProjects(supabase: Awaited<ReturnType<typeof createClient>>, userId: string) {
  return supabase
      ...
      <div className="max-w-[1100px] mx-auto px-6 lg:px-10 py-12 lg:py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-muted-fg mt-3 font-[family-name:var(--font-ui)]">
            Here's where your work with Design over Atlanta stands.
          </p>
        </div>
          ...
          <div className="glass rounded-2xl p-7 lg:p-8 border border-primary/30 mb-10 flex flex-col sm:flex-row sm:items-center justify-between gap-5">
            <div>
              ...
              <p className="text-muted-fg text-sm font-[family-name:var(--font-ui)] max-w-md">
                Tell us exactly what you're building and we'll turn it into a
                free, live demo within 48 hours.
              </p>
            </div>
            <Link
              href="/start"
        ...
        {lead && (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            ...
            <StatCard label="Next up" value={nextMs?.title ?? "All done"} />
            <StatCard
              label="Briefs"
              value={String(submissions?.length ?? 0)}
            />
          </div>
        )}
                  ...
                  >
                    ...
                    {d.href ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-[0.15em] text-primary border border-primary/40 rounded-full px-3 py-1 hover:border-primary/70 transition-colors"
                      >
                        {d.status} ↗
                      </a>
                    ) : (
                      <span className="font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-[0.15em] text-muted-fg border border-border/40 rounded-full px-3 py-1">
                        {d.status}
                      </span>
                    )}
                  </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-fg text-xs mt-1 font-[family-name:var(--font-ui)]">
                      ...
                      updates as your build moves, so check back anytime.
                    </p>
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-[family-name:var(--font-ui)] text-sm text-foreground/70">
                      Need something now?
                    </p>
                    <p className="text-muted-fg text-xs mt-1 font-[family-name:var(--font-ui)]">
                      Use the quick actions below to send a change or reach
                      Hunter directly.
                    </p>
                  </div>
                </div>
...
function ActionCard({
  ...
  return (
    <a
      href={href}
      className="group rounded-xl border border-border/30 bg-card/30 hover:border-primary/40 hover:bg-card/50 transition-all p-5 block"
    >
